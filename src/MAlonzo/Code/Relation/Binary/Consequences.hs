...
du152 v0 v1 v2 v3 v4 v5
  = let v6 = coe v2 v3 v4 in
    case coe v6 of
      MAlonzo.Code.Data.Sum.C24 v7 -> coe v7
      MAlonzo.Code.Data.Sum.C28 v7
        -> coe
...
du210 v0 v1 v2 v3 v4
  = let v5 = coe v1 v3 v4 in
    case coe v5 of
      MAlonzo.Code.Data.Sum.C24 v6
        -> coe MAlonzo.Code.Relation.Nullary.C22 v6
      MAlonzo.Code.Data.Sum.C28 v6
  ...
  = let v4 = coe v1 v3 v2 in
    case coe v4 of
      ...
      MAlonzo.Code.Relation.Binary.Core.C416 v7
        -> coe MAlonzo.Code.Data.Empty.d10 v0 erased erased
      _ -> coe MAlonzo.RTE.mazUnreachableError
name540 = "Relation.Binary.Consequences.P-resp\10230\172P-resp"
d540 = erased
name564 = "Relation.Binary.Consequences.tri\10230dec\8776"
d564 v0 v1 v2 v3 v4 v5 v6 v7 v8 = du564 v6 v7 v8
du564 v0 v1 v2
  = let v3 = coe v0 v1 v2 in
    case coe v3 of
      ...
      MAlonzo.Code.Relation.Binary.Core.C416 v6
        -> coe MAlonzo.Code.Relation.Nullary.C26
      _ -> coe MAlonzo.RTE.mazUnreachableError
name612 = "Relation.Binary.Consequences.tri\10230dec<"
d612 v0 v1 v2 v3 v4 v5 v6 v7 v8 = du612 v6 v7 v8
du612 v0 v1 v2
  = let v3 = coe v0 v1 v2 in
    case coe v3 of
      MAlonzo.Code.Relation.Binary.Core.C400 v4
      ...
      MAlonzo.Code.Relation.Binary.Core.C416 v6
        -> coe MAlonzo.Code.Relation.Nullary.C26
      _ -> coe MAlonzo.RTE.mazUnreachableError
name664 = "Relation.Binary.Consequences.map-NonEmpty"
d664 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9 = du664 v8 v9
du664 v0 v1
  = coe
